...
import static io.github.potjerodekool.openapi.internal.util.Utils.asGeneric;
...
public class ImportOrganiser extends GenericVisitorWithDefaults<Object, Object> {
    ...
    public Object visit(final WildcardType n, final Object arg) {
        n.getExtendedType().ifPresent(extendedType -> extendedType.accept(this, arg));
        n.getSuperType().ifPresent(superType -> superType.accept(this, arg));
        n.getAnnotations().accept(this, arg);
        return n;
    }
