...
import io.github.potjerodekool.openapi.internal.generate.model.adapter.*;
import io.github.potjerodekool.openapi.internal.generate.model.builder.JavaModelBuilder;
...
public class ModelsGenerator implements OpenApiWalkerListener {
    ...
    private void registerDefaultModelAdapters(final DependencyChecker dependencyChecker) {
        ...
        this.adapters.add(new SpringModelAdapter());
