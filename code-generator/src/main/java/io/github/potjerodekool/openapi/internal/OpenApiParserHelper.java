...
import io.github.potjerodekool.openapi.internal.util.ParseException;
...
public class OpenApiParserHelper {
    ...
    public static OpenApi3 merge(final File file) {
        final OpenApi3 rootFile = parse(file);
    ...
    public static OpenApi3 parse(final File file) {
        try {
            final var openApi =  (OpenApi3Impl) parser.parse(file);
            final var creatingRef = openApi._getCreatingRef();
