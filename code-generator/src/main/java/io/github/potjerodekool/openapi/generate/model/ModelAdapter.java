...
public interface ModelAdapter {
    default void adaptField(HttpMethod httpMethod,
                    ...
                    OpenApiProperty property, VariableElement field) {
    }
    ...
    default void adaptSetter(HttpMethod httpMethod, RequestCycleLocation requestCycleLocation, OpenApiProperty property, MethodElement method) {
    }
}
